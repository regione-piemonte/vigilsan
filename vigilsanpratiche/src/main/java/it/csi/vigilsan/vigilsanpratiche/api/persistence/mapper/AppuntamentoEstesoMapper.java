...
public class AppuntamentoEstesoMapper implements RowMapper<ModelAppuntamentoEsteso> {


	private AppuntamentoMapper<AppuntamentoEsteso> appuntamentoMapper;
	
	public AppuntamentoEstesoMapper() {
		super();
		this.appuntamentoMapper = new AppuntamentoMapper<>(AppuntamentoEsteso.class);
	}

	@Override
	public ModelAppuntamentoEsteso mapRow(ResultSet rs, int rowNum) throws SQLException {

		AppuntamentoEsteso res = appuntamentoMapper.mapRow(rs, rowNum);
