...
******************************************************************************/
package it.csi.vigilsan.vigilsanbatchsrv.rpvinv.service.impl;
...
@Service
public class RpvinvServiceImpl extends AuditableApiServiceImpl {

	@Autowired
	private VigilsanCommonService vigilsanCommonService;

	public void postBatchControlloNotifysan(Integer sId, String nomeBatch, HttpHeaders httpHeaders)
			throws IOException {
		...
		vigilsanCommonService.getGenericPost(VigilsanCommonPostApiEnum.POST_CONTROLLONOTIFYSAN, null, headers, queryParam, sId);
	}
